...
class MassPublic extends \Aheadworks\Pquestion\Controller\Adminhtml\Question
{
    /**
    ...
    public function execute()
    {
        ...
        foreach ($this->_collection->getItems() as $question) {
            if ($question->getVisibility() == \Aheadworks\Pquestion\Model\Source\Question\Visibility::PUBLIC_VALUE) {
                continue;
            }
            $question
        ...
        $this->messageManager->addSuccess(
            __('A total of %1 record(s) have been made public.', $count)
        );
