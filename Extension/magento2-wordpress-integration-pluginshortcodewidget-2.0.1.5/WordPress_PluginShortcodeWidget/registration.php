...
/*
 *
 * WordPress_PluginShortcodeWidget
 * https://fishpig.co.uk/
 *
 */
...
ComponentRegistrar::register(
	...
	'FishPig_WordPress_PluginShortcodeWidget',
	__DIR__
);
...
if (strpos($currentLocation, 'app' . DIRECTORY_SEPARATOR . 'code' . DIRECTORY_SEPARATOR) !== false) {
	$relativeLocation = 'app' . DIRECTORY_SEPARATOR . 'code' . DIRECTORY_SEPARATOR . 'FishPig' . DIRECTORY_SEPARATOR . 'WordPress_PluginShortcodeWidget';
	...
	if (strpos($currentLocation, $relativeLocation) === false) {
		throw new \Exception(sprintf(
			...
			"FishPig_WordPress_PluginShortcodeWidget",
			$relativeLocation,
			'FishPig' . DIRECTORY_SEPARATOR . 'WordPress_PluginShortcodeWidget'
		));
	}
}
