<?php
/**
 * Custom Options Inside Form for Apply field/drop-down
 *
 * @category    Rycoweb
 * @package     Rycoweb_SpecialPromotions
 */
class Rycoweb_SpecialPromotions_Block_Adminhtml_Promo_Quote_Edit_Tab_Actions
    extends Mage_Adminhtml_Block_Promo_Quote_Edit_Tab_Actions
{
    /**
     * Override function for Adding new custom options for Apply field/drop-down
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('simple_action', 'select', array(
            ...
            'options'   => array(
                ...
                Rycoweb_SpecialPromotions_Model_Rule::USE_BULK_PRICE_ACTION => Mage::helper('salesrule')->__('Use Bulk Price'),
            ),
        ));
        ...
        /* Below line play important role*/
        return $this;
