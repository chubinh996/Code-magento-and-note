...
namespace RDSC\CustomProductReview\Setup;

/**
 * Class InstallSchema
 * @package RDSC\CustomProductReview\Setup
...
class InstallSchema implements \Magento\Framework\Setup\InstallSchemaInterface
{
        ...
        \Magento\Framework\Setup\ModuleContextInterface $context)
    {
        ...
        $table = $installer->getConnection()->newTable(
            $installer->getTable('rdsc_productreviewimages')
        )->addColumn(
            ...
            $installer->getFkName(
                'rdsc_productreviewimages', 'review_id', 'review', 'review_id'
